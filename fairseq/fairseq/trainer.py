...
class Trainer(object):
    ...
    def load_checkpoint(
        ...
        if last_optim_state is not None and not reset_optimizer:
            ...
            if not reset_lr_scheduler:
                print("using the old lr scheduler ...")
    ...
    def get_train_iterator(
        ...
        # print("--- batch_iterator built ----- ")

        self.reset_dummy_batch(batch_iterator.first_batch)
        # print("check whether batch_iterator.first_batch is the same as last epoch")
        # print("batch_iterator.first_batch: ", batch_iterator.first_batch)
        # print("batch_iterator.frozen_batches: ", batch_iterator.frozen_batches)
        print("self.task.datasets: ", self.task.datasets)
       # breakpoint()
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        if not overflow or self.cfg.distributed_training.ddp_backend == "slow_mo":
            ...
            if self.tpu:
                ...
                # log stats
                # print("-"*100)
                # print("logging_outputs before reducing: ", logging_outputs)
                logging_output = self._reduce_and_log_stats(logging_outputs, sample_size, grad_norm)
                # print("logging_output after reducing: ", logging_output)
                # print("-"*100)
