...
def progress_bar(
    ...
    #breakpoint()
    if log_format == "tqdm" and not sys.stderr.isatty():  # ??????? Mich commented this out
         log_format = "simple"
    #print("log_format: 000000000000000", log_format)
    if log_format == "json":
