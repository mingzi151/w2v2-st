...
class MultiheadAttention(nn.Module):
    ...
    def forward(
        ...
        if (
            ...
            # print("*"*100)
            # print("self.self_attention: ", self.self_attention)
            # print("self.encoder_decoder_attention: ", self.encoder_decoder_attention)
            # breakpoint()
        ...
        if self.self_attention:
            ...
            # breakpoint()
            q = self.q_proj(query)   # query: T x B x D
            if key is None:
