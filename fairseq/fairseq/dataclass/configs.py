...
class DatasetConfig(FairseqDataclass):
    ...
    one_batch_only: bool = field(
        default=False, metadata={"help": "Try overfitting on one batch. Sanity check for the code"}
    )
...
class CommonEvalConfig(FairseqDataclass):
    ...
    task_overrides: str = field(
        default="{}",
        metadata={
            "help": "a dictionary used to override task args at generation that were used during model training"
        },
    )
